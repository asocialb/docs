...
Данный API используется для запроса ключа аутентификации воспроизведения.
...
| --- | --- | --- | --- |
| Action | Да | String | [Общие параметры](https://intl.cloud.tencent.com/document/api/267/30763). Значение для данного API: DescribeLivePlayAuthKey. |
...
| --- | --- | --- |
| PlayAuthKeyInfo | [PlayAuthKeyInfo](https://intl.cloud.tencent.com/document/api/267/30767#PlayAuthKeyInfo) | Информация о ключе аутентификации воспроизведения. |
...
---
*Source: [https://www.tencentcloud.com/document/product/267/30772](https://www.tencentcloud.com/document/product/267/30772)*
