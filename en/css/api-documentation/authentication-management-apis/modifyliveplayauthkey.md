...
| --- | --- | --- | --- |
| Action | Yes | String | [Common Params](https://intl.cloud.tencent.com/document/api/267/30763). The value used for this API: ModifyLivePlayAuthKey. |
...
| AuthKey | No | String | Authentication key. If this parameter is left empty, the current value will not be modified. |
| AuthDelta | No | Integer | Validity period in seconds. If this parameter is left empty, the current value will not be modified. |
| AuthBackKey | No | String | Backup authentication key. If this parameter is left empty, the current value will not be modified. |
