...
| --- | --- | --- | --- |
| Action | Yes | String | [Common Params](https://intl.cloud.tencent.com/document/api/267/30763). The value used for this API: UnBindLiveDomainCert. |
...
| Type | No | String | Valid values: `gray`: unbind the canary certificate `formal` (default): unbind the formal certificate  `formal` will be used if no value is passed in |
...
---
*Source: [https://www.tencentcloud.com/document/product/267/30774](https://www.tencentcloud.com/document/product/267/30774)*
