...
| --- | --- | --- | --- |
| Action | Yes | String | [Common Params](https://intl.cloud.tencent.com/document/api/267/30763). The value used for this API: DescribeLiveDelayInfoList. |
...
| --- | --- | --- |
| DelayInfoList | Array of [DelayInfo](https://intl.cloud.tencent.com/document/api/267/30767#DelayInfo) | Delayed playback information list. |
...
---
*Source: [https://www.tencentcloud.com/document/product/267/33532](https://www.tencentcloud.com/document/product/267/33532)*
