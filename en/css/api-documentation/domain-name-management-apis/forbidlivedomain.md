...
| --- | --- | --- | --- |
| Action | Yes | String | [Common Params](https://intl.cloud.tencent.com/document/api/267/30763). The value used for this API: ForbidLiveDomain. |
...
| DomainName | Yes | String | LVB domain name to be disabled. |
...
### Example1 Disabling a domain name
...
---
*Source: [https://www.tencentcloud.com/document/product/267/35184](https://www.tencentcloud.com/document/product/267/35184)*
