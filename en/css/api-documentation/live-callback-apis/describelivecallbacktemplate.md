...
| --- | --- | --- | --- |
| Action | Yes | String | [Common Params](https://intl.cloud.tencent.com/document/api/267/30763). The value used for this API: DescribeLiveCallbackTemplate. |
...
| TemplateId | Yes | Integer | Template ID. 1. Get the template ID in the returned value of the [CreateLiveCallbackTemplate](https://intl.cloud.tencent.com/document/product/267/32637?from_cn_redirect=1) API call. 2. You can query the list of created templates through the [DescribeLiveCallbackTemplates](https://intl.cloud.tencent.com/document/product/267/32632?from_cn_redirect=1) API. |

## 3. Output Parameters

| Parameter Name | Type | Description |
| --- | --- | --- |
| Template | [CallBackTemplateInfo](https://intl.cloud.tencent.com/document/api/267/30767#CallBackTemplateInfo) | Callback template information. |
...
---
*Source: [https://www.tencentcloud.com/document/product/267/30811](https://www.tencentcloud.com/document/product/267/30811)*
