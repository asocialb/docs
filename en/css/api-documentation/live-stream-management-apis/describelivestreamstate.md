...
If possible, use your own logic of stream starting/stopping in a room, such as streaming signaling on the client and the online heartbeat of a host, to determine whether the host is online.
If your application does not provide the room management feature, use the following methods to determine whether a host is online:
2.1 Use the
live stream callback
.
2.2 Call
DescribeLiveStreamOnlineList
on a regular basis (interval > 1 min).
2.3 Call this API.
...
| --- | --- | --- | --- |
| Action | Yes | String | [Common Params](https://www.tencentcloud.com/document/api/267/30763). The value used for this API: DescribeLiveStreamState. |
...
### Example1 Creating the status of a stream
...
---
*Source: [https://www.tencentcloud.com/document/product/267/30796](https://www.tencentcloud.com/document/product/267/30796)*
