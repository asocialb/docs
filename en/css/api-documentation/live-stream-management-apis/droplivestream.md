...
| --- | --- | --- | --- |
| Action | Yes | String | [Common Params](https://www.tencentcloud.com/document/api/267/30763). The value used for this API: DropLiveStream. |
...
| DomainName | Yes | String | Your push domain. |
| AppName | Yes | String | The push path, which should be the same as `AppName` in the push and playback URL. The default value is `live`. |
...
This example shows you how to pause pushing a stream.
...
---
*Source: [https://www.tencentcloud.com/document/product/267/30795](https://www.tencentcloud.com/document/product/267/30795)*
