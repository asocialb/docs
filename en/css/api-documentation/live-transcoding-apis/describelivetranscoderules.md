...
| --- | --- | --- | --- |
| Action | Yes | String | [Common Params](https://www.tencentcloud.com/document/api/267/30763). The value used for this API: DescribeLiveTranscodeRules. |
...
| TemplateIds.N | No | Array of Integer | An array of template IDs to be filtered. |
| DomainNames.N | No | Array of String | An array of domain names to be filtered. |

## 3. Output Parameters

| Parameter Name | Type | Description |
| --- | --- | --- |
| Rules | Array of [RuleInfo](https://www.tencentcloud.com/document/api/267/30767#RuleInfo) | List of transcoding rules. |
...
---
*Source: [https://www.tencentcloud.com/document/product/267/30787](https://www.tencentcloud.com/document/product/267/30787)*
