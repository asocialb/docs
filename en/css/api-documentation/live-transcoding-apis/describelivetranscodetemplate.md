...
| --- | --- | --- | --- |
| Action | Yes | String | [Common Params](https://www.tencentcloud.com/document/api/267/30763). The value used for this API: DescribeLiveTranscodeTemplate. |
...
| TemplateId | Yes | Integer | Template ID. Note: get the template ID in the returned value of the [CreateLiveTranscodeTemplate](https://intl.cloud.tencent.com/document/product/267/32646?from_cn_redirect=1) API call. |

## 3. Output Parameters

| Parameter Name | Type | Description |
| --- | --- | --- |
| Template | [TemplateInfo](https://www.tencentcloud.com/document/api/267/30767#TemplateInfo) | Template information. |
...
---
*Source: [https://www.tencentcloud.com/document/product/267/30786](https://www.tencentcloud.com/document/product/267/30786)*
