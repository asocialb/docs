...
**Note: Other parameter values also need to be encoded using [RFC 3986](https://datatracker.ietf.org/doc/html/rfc3986). Use %XY in percent-encoding for special characters such as Chinese characters, where "X" and "Y" are hexadecimal characters (0-9 and uppercase A-F), and using lowercase will cause an error.**
...
---
*Source: [https://www.tencentcloud.com/document/product/267/37448](https://www.tencentcloud.com/document/product/267/37448)*
