...
| --- | --- | --- | --- |
| Action | Yes | String | [Common Params](https://www.tencentcloud.com/document/api/267/30763). The value used for this API: CreateLiveTimeShiftTemplate. |
...
| TemplateName | Yes | String | The template name. Maximum length: 255 bytes. Only letters, numbers, underscores, and hyphens are supported. |
| Duration | Yes | Integer | The time shifting duration. Unit: Second. |
| Description | No | String | The template description. Only letters, numbers, underscores, and hyphens are supported. |
...
---
*Source: [https://www.tencentcloud.com/document/product/267/53725](https://www.tencentcloud.com/document/product/267/53725)*
