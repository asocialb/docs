...
| --- | --- | --- | --- |
| Action | Yes | String | [Common Params](https://www.tencentcloud.com/document/api/267/30763). The value used for this API: CreateLiveWatermarkRule. |
...
| TemplateId | Yes | Integer | Watermark ID, which is the `WatermarkId` returned by the [AddLiveWatermark](https://intl.cloud.tencent.com/document/product/267/30154?from_cn_redirect=1) API. |
...
---
*Source: [https://www.tencentcloud.com/document/product/267/30825](https://www.tencentcloud.com/document/product/267/30825)*
