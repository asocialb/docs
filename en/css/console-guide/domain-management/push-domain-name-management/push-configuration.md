...
1. Go to [Domain Management](https://console.tencentcloud.com/live/domainmanage), click the target **push domain name** or click **Manage** to enter the domain details page.
...
3. Go to the push authentication configuration page and click ![](https://staticintl.cloudcachetci.com/cms/backend-cms/b43831edaafd11f0b08552540044a08e.png)to turn on/off push authentication.
...
1. Go to [Domain Management](https://console.tencentcloud.com/live/domainmanage), click the target domain name or click **Manage** on its right to enter the details page.
...
![](https://staticintl.cloudcachetci.com/cms/backend-cms/d04405c6aafe11f0a0a052540099c741.png)
  ...
  2.2. Enter a custom stream name (`StreamName`), For example: livetest.
  2.3. Select an expiration time, such as `2025-10-18 09:58:57`.
...
> **Note:**If you have enabled authentication, `txTime` indicates the expiration time of the URL.For the sake of convenience, the console allows you to specify the URL expiration time in human-readable format. **If you enable authentication, when generating push URLs, the system will convert it to a hex timestamp (the value of**`txTime`**)**.As long as you start push or playback before the expiration time and the stream is not interrupted, the push or playback can continue even after the URL expires.
...
1. Log in to the CSS console and click [Domain Management](https://console.tencentcloud.com/live/domainmanage).
...
---
*Source: [https://www.tencentcloud.com/document/product/267/31059](https://www.tencentcloud.com/document/product/267/31059)*
