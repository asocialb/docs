...
| --- | --- | --- | --- |
| Action | Yes | String | [Common Params](https://www.tencentcloud.com/document/api/1041/33628). The value used for this API: ModifyProcessImageTemplate. |
...
| Definition | Yes | Integer | Unique identifier of the image processing template. |
...
| ProcessImageTemplate | No | [ImageTaskInput](https://www.tencentcloud.com/document/api/1041/33690#ImageTaskInput) | Image processing template parameter. |
...
### Example1 Modifying an Image Processing Template

This example shows you how to modify an image processing template.
...
---
*Source: [https://www.tencentcloud.com/document/product/1041/74707](https://www.tencentcloud.com/document/product/1041/74707)*
