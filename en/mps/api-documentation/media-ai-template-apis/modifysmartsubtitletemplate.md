...
| --- | --- | --- | --- |
| Action | Yes | String | [Common Params](https://www.tencentcloud.com/document/api/1041/33628). The value used for this API: ModifySmartSubtitleTemplate. |
...
| ProcessType | No | Integer | Subtitle processing type: - 0: ASR recognition subtitle. - 1: pure subtitle translation. - 2: OCR recognition subtitle. **Note**: If the field is unspecified, ASR is used by default. |
...
---
*Source: [https://www.tencentcloud.com/document/product/1041/68916](https://www.tencentcloud.com/document/product/1041/68916)*
