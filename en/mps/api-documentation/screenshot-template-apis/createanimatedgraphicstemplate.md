...
| --- | --- | --- | --- |
| Action | Yes | String | [Common Params](https://www.tencentcloud.com/document/api/1041/33628). The value used for this API: CreateAnimatedGraphicsTemplate. |
...
| Fps | Yes | Integer | Video frame rate in Hz. Value range: [1, 30]. |
...
| Format | No | String | Animated image format. Valid values: gif; webp. Default value: gif. |
...
---
*Source: [https://www.tencentcloud.com/document/product/1041/33676](https://www.tencentcloud.com/document/product/1041/33676)*
