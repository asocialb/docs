...
| --- | --- | --- | --- |
| Action | Yes | String | [Common Params](https://www.tencentcloud.com/document/api/1041/33628). The value used for this API: CreateWatermarkTemplate. |
...
| Type | Yes | String | Watermarking type. Valid values: image: Image watermark;text: Text watermark;svg: SVG watermark. |
...
| ImageTemplate | No | [ImageWatermarkInput](https://www.tencentcloud.com/document/api/1041/33690#ImageWatermarkInput) | Image watermarking template. This field is required and valid only when `Type` is `image`. |
| TextTemplate | No | [TextWatermarkTemplateInput](https://www.tencentcloud.com/document/api/1041/33690#TextWatermarkTemplateInput) | Text watermarking template. This field is required and valid only when `Type` is `text`. |
| SvgTemplate | No | [SvgWatermarkInput](https://www.tencentcloud.com/document/api/1041/33690#SvgWatermarkInput) | SVG watermarking template. This field is required and valid only when `Type` is `svg`. |
...
---
*Source: [https://www.tencentcloud.com/document/product/1041/33670](https://www.tencentcloud.com/document/product/1041/33670)*
