...
| Type | Description |
| --- | --- |
| [General transcoding](#general-transcoding-resource-pack) | Each general transcoding resource pack contains **a certain number of minutes** and can be used to deduct **General Transcoding, Adaptive Bitrate Streaming (General Transcoding Substreams) and Video Editing** ([Related API Documents](https://www.tencentcloud.com/document/product/1041/37460)), regardless of the region. |
| [Top Speed Codec transcoding](#tsc-transcoding-resource-pack) | Each TSC transcoding resource pack contains **a certain number of minutes** and can be used to deduct **TSC Transcoding and Adaptive Bitrate Streaming (TSC Transcoding Substreams) durations** regardless of the region. |

> **Note:****Starting January 2025, Off-Peak Transcoding Resource Packs is no longer available.**The "Off-Peak General Transcoding Pack" and "Off-Peak Top Speed Codec Transcoding Pack" were discontinued in January 2025 and are no longer available for new purchases. Previously purchased packs will continue to function normally.

You can view your media processing usages in the [MPS console](https://console.tencentcloud.com/mps). To buy a resource pack, go to the [MPS purchase page](https://buy.tencentcloud.com/mps).

## General Transcoding Resource Pack

A general transcoding resource pack can deduct your usage of the **General Transcoding, Adaptive Bitrate Streaming (General Transcoding Substreams) and Video Editing** ([Related API Documents](https://www.tencentcloud.com/document/product/1041/37460))features of MPS. If you have bought multiple packs, the one that expires first will be used first. The system will calculate your total usage of general transcoding and adaptive bitrate streaming each day and will deduct some or all of it (depending on the remaining minutes of your resource packs) from the applicable resource packs. The usage not deducted by resource packs will be billed at [pay-as-you-go rates](https://www.tencentcloud.com/document/product/1041/49204).
...
| MV-HEVC | FHD (short side ≤ 1080 px) | 1 **:** 60 |
| MV-HEVC | 2K (short side ≤ 1440 px) | 1 **:** 120 |
| MV-HEVC | 4K (short side ≤ 2160 px) | 1 **:** 240 |
| MV-HEVC | 8K (short side ≤ 4320 px) | 1 **:** 880 |
...
- Suppose the general transcoding feature was used to transcode a video of one minute. The H.264 codec was used and the output resolution was 1280 x 720 px. Two minutes would be deducted from a general transcoding resource pack.
...
| MV-HEVC | 2K (short side ≤ 1440 px) | 1 **:** 120 |
| MV-HEVC | 4K (short side ≤ 2160 px) | 1 **:** 240 |
| MV-HEVC | 8K (short side ≤ 4320 px) | 1 **:** 560 |
...
## Off-Peak Transcoding Resource Pack

> **Note:****Starting January 2025, Off-Peak Transcoding Resource Packs is no longer available.**The "Off-Peak General Transcoding Pack" and "Off-Peak Top Speed Codec Transcoding Pack" were discontinued in January 2025 and are no longer available for new purchases. Previously purchased packs will continue to function normally.


---
*Source: [https://www.tencentcloud.com/document/product/1041/48810](https://www.tencentcloud.com/document/product/1041/48810)*
