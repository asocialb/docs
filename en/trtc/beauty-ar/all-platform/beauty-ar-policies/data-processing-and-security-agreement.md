...
| --- | --- |
| **Photos or Videos of your end users** | We use this information for the purpose of providing this Feature to you, by applying the relevant beautification effect.The Feature will not store or further process the photos or videos once the beautification effect has been applied. |
| **Device and Technical Data of your end users**:  Wi-Fi status,  system attributes (system properties), device model, operating system, sensor information (horizontal and vertical screen status of the device), application package name, app name | We use this information for the purpose of providing this Feature to you.The Feature will not store or further process the photos or videos once the beautification effect has been applied. |

Our personnel will not store or have access to the above data.
...
| --- | --- |
| **Photos or Videos of your end users** | This data is not stored. |
| **Device and Technical Data of your end users** | We retain such information for 1 year (unless in special circumstances such as hacking of or an attack on your account, in which case we will discuss the same with you and may (if considered necessary) delete such data). |
...
---
*Source: [https://trtc.io/document/71622](https://trtc.io/document/71622)*
