...
Refer to [LIVE_Adapter_Example](https://mediacloud-76607.gzc.vod.tencent-cloud.com/TencentEffect/iOS/latest/MLVB-API-Example.zip).

## Integration Steps

1. (Optional) Integrate [TELiveAdapter](https://mediacloud-76607.gzc.vod.tencent-cloud.com/TencentEffect/iOS/latest/TELiveAdapter.framework.zip). The TELiveAdapter.framework is used to receive video callbacks from the MLVB SDK, process them internally using the beauty filter SDK, and then return them to the MLVB SDK. If you need to perform custom processing on the video stream, you can skip this step.
...
If TELiveAdapter is not integrated, please refer directly to [step 7](#98c89154-351f-4e49-9786-3c1b681cf7a2).
...
---
*Source: [https://trtc.io/document/73774](https://trtc.io/document/73774)*
