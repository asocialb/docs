...
## [Common Parameter (OfflinePushInfo Description)](https://www.tencentcloud.com/document/product/1047/77715)

OfflinePushInfo is a JSON Object dedicated to offline push configuration, allowing you to configure whether to disable push for the message, push text, pass-through string, etc. If you fill in the corresponding field in OfflinePushInfo, the offline push-related configuration in TIMCustomElem will be ignored. For details, refer to [Common Parameter (OfflinePushInfo Description)](https://www.tencentcloud.com/document/product/1047/77715).

Example formats for MsgBody and OfflinePushInfo are as follows:
...
---
*Source: [https://trtc.io/document/33527](https://trtc.io/document/33527)*
