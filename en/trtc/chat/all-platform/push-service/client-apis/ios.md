...
| --- | --- | --- |
| sdkAppId | The application ID assigned to you by the Chat console. | ![](https://cloudcache.intl.tencent-cloud.com/cms/backend-cms/bc8f5122c36c11ef85bd525400454e06.png) |
...
| Parameter | Description |
| --- | --- |
| registrationID | The device's push identifier ID will change if you uninstall and reinstall. |
...
---
*Source: [https://trtc.io/document/60558](https://trtc.io/document/60558)*
