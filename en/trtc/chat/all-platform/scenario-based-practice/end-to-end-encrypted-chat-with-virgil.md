...
The diagram below shows the high-level communication flowï¼
...
> Noteï¼User of im_ ID and user registered on virtilsecurity_ The id should be consistent

### **Start a one-to-one chat**

1.Call the ethree.createRatchetChannel method in the E3Kit to create a one to one session (User1 and User2), and the corresponding operation document link: [https://developer.virgilsecurity.com/docs/e3kit/end-to-end-encryption/double-ratchet/?#create -channel](https://developer.virgilsecurity.com/docs/e3kit/end-to-end-encryption/double-ratchet/#create-channel)
...
1.Use the channel created above to encrypt messages and link documentsï¼[https://developer.virgilsecurity.com/docs/e3kit/end-to-end-encryption/double-ratchet/?#encrypt-and-decrypt-messages](https://developer.virgilsecurity.com/docs/e3kit/end-to-end-encryption/double-ratchet/#encrypt-and-decrypt-messages)
...
1.Call the ethree.createGroup to create groupï¼document linkï¼[https://developer.virgilsecurity.com/docs/e3kit/end-to-end-encryption/group-chat/?#create-group-chat](https://developer.virgilsecurity.com/docs/e3kit/end-to-end-encryption/group-chat/#create-group-chat)
...
2.If you need to add group members, the code below is as follows. You can call the remove method to delete a group member. Document linkï¼[https://developer.virgilsecurity.com/docs/e3kit/end-to-end-encryption/group-chat/?#add-new-participant](https://developer.virgilsecurity.com/docs/e3kit/end-to-end-encryption/group-chat/#add-new-participant)
...
1.Use the group created above to encrypt messages and link documentsï¼[https://developer.virgilsecurity.com/docs/e3kit/end-to-end-encryption/group-chat/?#encrypt-and-decrypt-messages](https://developer.virgilsecurity.com/docs/e3kit/end-to-end-encryption/group-chat/#encrypt-and-decrypt-messages)
...
4.The peer decrypt and render it, as followsï¼
...
```
            â Reliable technical support             â Product details            â Constant exchange of ideas
```
...
---
*Source: [https://trtc.io/document/53932](https://trtc.io/document/53932)*
