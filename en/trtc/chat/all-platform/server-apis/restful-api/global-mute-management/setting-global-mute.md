...
```
{    "Set_Account": "lumotuwe",    "C2CmsgNospeakingTime": 4294967295, // `C2CmsgNospeakingTime` and `GroupmsgNospeakingTime` are optional, but either of them must be specified.    "GroupmsgNospeakingTime": 7200}
```
...
| C2CmsgNospeakingTime | Integer | Optional | Muting period (in seconds) of one-to-one messages. The value is a non-negative integer, and the maximum value is 4294967295 (0xFFFFFFFF in hexadecimal format).0: the account is unmuted4294967295: the account is permanently mutedOther values: a specific muting period of the account |
| GroupmsgNospeakingTime | Integer | Optional | Muting period (in seconds) of group messages. The value is a non-negative integer, and the maximum value is 4294967295 (0xFFFFFFFF in hexadecimal format).0: the account is unmuted4294967295: the account is permanently mutedOther values: a specific muting period of the account |
...
---
*Source: [https://trtc.io/document/34923](https://trtc.io/document/34923)*
