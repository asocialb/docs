...
```
{    "GroupId": "@TGS#aC5SZEAEF",    "GroupCounterKeys":[    // List of group counter keys to delete. If no value is passed in, all group counter keys will be deleted.        "like",        "unlike"    ]}
```
...
---
*Source: [https://trtc.io/document/53429](https://trtc.io/document/53429)*
