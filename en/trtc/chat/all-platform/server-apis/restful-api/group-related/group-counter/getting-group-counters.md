...
```
{    "ActionStatus": "OK",    "ErrorInfo": "",    "ErrorCode": 0,    "GroupCounter":[        {            "Key":"like", // Group counter key            "Value":5 // Latest group counter value        }ï¼        {            "Key":"unlike",            "Value":1        }    ]}
```
...
---
*Source: [https://trtc.io/document/53427](https://trtc.io/document/53427)*
