...
> **Note:**To use this feature, you need to purchase the [Pro edition ãPro Plus edition or Enterprise edition](https://www.tencentcloud.com/document/product/1047/34577).
...
```
{    "GroupId": "@TGS#aC5SZEAEF",    "GroupCounter":[        {            "Key":"like", // Group counter key            "Value":5 // Group counter value        }ï¼        {            "Key":"unlike",            "Value":1        }    ],    "Mode": "Set"  // `Set`, `Increase`, `Decrease`}
```
...
```
{    "ActionStatus": "OK",    "ErrorInfo": "",    "ErrorCode": 0,    "GroupCounter":[  // List of the latest group counter key-value pairs updated        {            "Key":"like", // Group counter key            "Value":5 // Latest group counter value        }ï¼        {            "Key":"unlike",            "Value":1        }    ]}
```
...
| 10059 | To use this feature, you need to purchase the Pro edition ãPro Plus edition or Enterprise edition. |
| 10063 | The number of keys in the group counter exceeds the limit of 20. |


---
*Source: [https://trtc.io/document/53428](https://trtc.io/document/53428)*
