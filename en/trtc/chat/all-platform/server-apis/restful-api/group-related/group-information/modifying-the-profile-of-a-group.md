...
Set a group's custom field information. By default, custom information is not available and needs to be enabled in the [Chat console](https://console.tencentcloud.com/im). For details, see the description table for request packet fields.
...
| MaxMemberNum | Integer | No | Maximum number of group membersFor work groups (Work), public groups (Public), meeting groups (Meeting), and communities, see the upper limit on the number of group members in [Group System](https://intl.cloud.tencent.com/document/product/1047/33529#.E7.BE.A4.E7.BB.84.E9.99.90.E5.88.B6.E5.B7.AE.E5.BC.82).For audio-video groups (AVChatRoom), this field is invalid and doesn't need to be specified. |
...
| EnablePermission | Integer | Optional | Only communities that support topics can set this field.Whether to enable the permission group as the basis for permission judgement:0: Disable1: Enable |
...
| 10026 | The command word of the SDKAppID request is disabled. Please [submit a ticket](https://console.tencentcloud.com/workorder/category?level1_id=29&level2_id=40&source=0&data_title=%E4%BA%91%E9%80%9A%E4%BF%A1%20%20IM&step=1). |
...
---
*Source: [https://trtc.io/document/34962](https://trtc.io/document/34962)*
