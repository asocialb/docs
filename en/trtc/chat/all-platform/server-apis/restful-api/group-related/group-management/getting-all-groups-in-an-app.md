...
For example, if paged pulling is requested and 20 group IDs are displayed per page, the request parameters for the first page are `{âLimitâ : 20, âNextâ : 0}`, whereas those for the second page are `{âLimitâ : 20, âNextâ : Previously returned Next value}`, and so on.
...
---
*Source: [https://trtc.io/document/34960](https://trtc.io/document/34960)*
