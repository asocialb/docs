...
```
{  "GroupId": "@TGS#2C5SZEAEF",  "Members_Account": [ // Up to 500 member accounts      "peter",      "leckie"  ],  "MuteTime": 60 // Muting period, in seconds}
```
...
```
{  "GroupId": "@TGS#2C5SZEAEF",  "Members_Account": [ // Up to 500 member accounts      "peter",      "leckie"  ],  "MuteTime": 0 // 0 indicates to unmute members.}
```
...
---
*Source: [https://trtc.io/document/34951](https://trtc.io/document/34951)*
