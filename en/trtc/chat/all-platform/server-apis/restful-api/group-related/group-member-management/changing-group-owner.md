...
```
{    "GroupId": "@TGS#1NVTZEAE4",  // (Required) ID of the group whose ownership is to be transferred    "NewOwner_Account": "peter" // (Required) ID of the new group owner}
```
...
- [Callback After the Group Owner Changed](https://trtc.io/document/60396?product=chat&menulabel=uikit&platform=react)


---
*Source: [https://trtc.io/document/34966](https://trtc.io/document/34966)*
