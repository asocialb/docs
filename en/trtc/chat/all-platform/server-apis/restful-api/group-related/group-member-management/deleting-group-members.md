...
```
{  "GroupId": "@TGS#2J4SZEAEL", // Target group (required)  "Silence": 1, // Whether to delete members silently (optional)  "MemberToDel_Account": [ // List of group members to be deleted. A maximum of 100 members can be deleted.      "tommy",      "jared"  ]}
```
...
---
*Source: [https://trtc.io/document/34949](https://trtc.io/document/34949)*
