...
This API is used to unban a member. An unbanned member can rejoin the audio-video group to receive messages.

> **Note:**group member unbanning is supported by SDK Enhanced edition v6.6 or later and web SDK v2.22.0 or later. To use it, you need to [purchase the Pro edition ãPro Plus edition or Enterprise edition](https://www.tencentcloud.com/document/product/1047/34577), go to the [console](https://console.trtc.io/chat/qun-setting), choose **Feature configuration** > **Group configuration** > ** Group feature configuration**, and disable **Audio-video group member banning**.
...
```
{    "GroupId": "@TGS#aJRGC4MH6",  // ID of the group whose members are to be unbanned    "Members_Account":[brennanli3", "brennanli12], // Account IDs of the members to be unbanned. Up to 20 account IDs are supported per request.}
```
...
Use the [RESTful API online debugging tool](https://tcc.tencentcs.com/im-api-tool/index.html#/v4/group_open_http_svc/unban_group_member) to debug this API.


---
*Source: [https://trtc.io/document/50297](https://trtc.io/document/50297)*
