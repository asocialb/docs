...
App admins and group owners can set different marks/labels for audio-video group members to distinguish different types of group members. To use this feature, you need to purchase the Pro edition ãPro Plus edition or Enterprise edition, enable **List of online audio-video group members** on the **Group configuration** page of the Chat console. For other plan editions, calling this API will fail.
...
---
*Source: [https://trtc.io/document/50294](https://trtc.io/document/50294)*
