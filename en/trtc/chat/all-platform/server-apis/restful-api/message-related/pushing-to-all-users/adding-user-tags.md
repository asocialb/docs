...
> **Note:**Each request can add tags for a maximum of 100 users. In the request body, a maximum of 10 tags can be added for each user.A maximum of 100 tags can be set for each user. If a user has more than 100 tags, you need to delete old tags before adding new ones for the user.The maximum length of a single tag is 50 bytes.
...
Use the [RESTful API online debugging tool](https://tcc.tencentcs.com/im-api-tool/index.html#/v4/all_member_push/im_add_tag) to debug this API.
...
---
*Source: [https://trtc.io/document/37173](https://trtc.io/document/37173)*
