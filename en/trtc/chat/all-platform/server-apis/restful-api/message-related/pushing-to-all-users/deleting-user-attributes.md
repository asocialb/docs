...
This API is used by the admin to delete attributes for users. Each request can delete attributes for a maximum of 100 users. Before using this API, be sure to [set app attribute names](https://intl.cloud.tencent.com/document/product/1047/37167).
...
| xxxxxx | Domain name corresponding to the country/region where your SDKAppID is located.China: `console.tim.qq.com`Singapore: `adminapisgp.im.qcloud.com`Seoul: `adminapikr.im.qcloud.com`Frankfurt: `adminapiger.im.qcloud.com`Tokyoï¼`adminapijpn.im.qcloud.com`Silicon Valley: `adminapiusa.im.qcloud.com`Jakarta:` adminapiidn.im.qcloud.com` |
...
| Attrs | Array | Yes | Tag set. Note that you only need to specify the attribute names here. For more information on the format and meanings of `Attrs`, see [Setting Application Attribute Names](https://intl.cloud.tencent.com/document/product/1047/37167). |
...
Use the [RESTful API online debugging tool](https://tcc.tencentcs.com/im-api-tool/index.html#/v4/all_member_push/im_remove_attr) to debug this API.
...
---
*Source: [https://trtc.io/document/37171](https://trtc.io/document/37171)*
