...
This API is used by the admin to set attributes for users. Each request can set attributes for a maximum of 100 users. Before using this API, be sure to [set app attribute names](https://intl.cloud.tencent.com/document/product/1047/37167).
...
| v4/all_member_push/im_set_attr | Request API |
...
| Attrs | Object | Yes | Attribute set. Each attribute is a key-value pair, with the key being the attribute name and the value being the userâs corresponding attribute value. A user attribute value cannot exceed 50 bytes. |
...
Use the [RESTful API online debugging tool](https://tcc.tencentcs.com/im-api-tool/index.html#/v4/all_member_push/im_set_attr) to debug this API.
...
---
*Source: [https://trtc.io/document/37170](https://trtc.io/document/37170)*
