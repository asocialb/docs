...
> **Note:**This feature is available only in the Pro edition ãPro Plus editionãEnterprise edition. To use it, you need to [purchase the Pro edition ãPro Plus editionãEnterprise edition](https://www.tencentcloud.com/document/product/1047/34577), go to the [**console**](https://console.tencentcloud.com/im/qun-setting), choose **Feature Configuration** > **Group configuration** > **Group Message Read Receipts**, and enable the feature.
...
```
{ "GroupId":"@TGS#2TTV7VSII", "MsgSeq": 1, "Filter": 1,        // `0`: Pull the list of members who have read the message; `1`: Pull the list of members who have not read the message "Cursor":"",      // Position of the last member pulled. Enter "" for the first request "Count":5           // Maximum number of members to pull}
```
...
Use the [RESTful API online debugging tool](https://tcc.tencentcs.com/im-api-tool/index.html#/v4/group_open_http_svc/get_group_msg_receipt_detail) to debug this API.

## References

[Pulling group message read receipt information](https://www.tencentcloud.com/zh/document/product/1047/49439)


---
*Source: [https://trtc.io/document/49438](https://trtc.io/document/49438)*
