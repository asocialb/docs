...
```
{âââ"ActionStatus" : "OK",âââ"ErrorInfo" : "",âââ"ErrorCode" : 0}
```
...
Use the [RESTful API online debugging tool](https://tcc.tencentcs.com/im-api-tool/index.html#/v4/openim/importmsg) to debug this API.
...
---
*Source: [https://trtc.io/document/35014](https://trtc.io/document/35014)*
