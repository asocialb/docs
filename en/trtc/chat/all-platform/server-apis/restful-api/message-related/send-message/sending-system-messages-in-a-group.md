...
> **Note**A non-audio-video group supports sending system notifications to specified group members, but an audio-video group (AVChatRoom) only supports sending system notifications to all group members.For more information on the API (`V2TIMGroupListener.onReceiveRESTCustomData`) for clients to receive system notifications, see [Android](https://im.sdk.qcloud.com/doc/en/classcom_1_1tencent_1_1imsdk_1_1v2_1_1V2TIMGroupListener.html#a0775a137d293473aaed4cf9fc4c18795) or [iOS](https://im.sdk.qcloud.com/doc/en/protocolV2TIMGroupListener-p.html#a989347c455869dc0aa44572f4f2b7041).This api is now offline. Use [sending messages in a group](https://www.tencentcloud.com/document/product/1047/34959) instead.
...
| ToMembers_Account | Array | Yes | List of recipients. Up to 50 recipient UserIDs are supported. You can leave this field empty to send the notification to all members. |
...
---
*Source: [https://trtc.io/document/34958](https://trtc.io/document/34958)*
