...
- Once a one-to-one message is recalled by this API, it is recalled from offline storage, roaming storage, and the local cache of the senderâs and recipientâs clients.
- This API can recall one-to-one messages sent at any time. Thereâs no time limit.

> **Note**Please note that one-to-one messages recalled by this API cannot be restored.
...
---
*Source: [https://trtc.io/document/35015](https://trtc.io/document/35015)*
