...
> **Chat Note**This document is only for users who are migrating their apps to Tencent Cloud Chat.
...
- When you are migrating your app from another Chat system to Tencent Cloud Chat, you can use this API to set the unread message count of group members.
...
These are the built-in group types in Chat. For detailed information, see [Group System](https://intl.cloud.tencent.com/document/product/1047/33529).

> **Note**ChatRoom and AVChatroom (audio-video) groups do not support unread message counts. Therefore, you cannot set an unread message count for members of these two group types. If you try to do so, no error will be returned.
...
| xxxxxx | The country/region where your SDKAppID is located.China:  `console.tim.qq.com `Singapore:  `adminapisgp.im.qcloud.com `Seoul: `adminapikr.im.qcloud.com`Frankfurt: `adminapiger.im.qcloud.com`Tokyoï¼`adminapijpn.im.qcloud.com`Silicon Valley: `adminapiusa.im.qcloud.com`Jakarta:` adminapiidn.im.qcloud.com` |
...
```
{    "GroupId": "@TGS#2CLUZEAEJ",  // Target group (required)    "Member_Account": "bob",  // Target group member (required)    "UnreadMsgNum":5          // Unread message count of the target member}
```
...
---
*Source: [https://trtc.io/document/34909](https://trtc.io/document/34909)*
