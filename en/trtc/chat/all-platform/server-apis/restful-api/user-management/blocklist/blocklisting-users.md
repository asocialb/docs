...
> **Note**If users A and B are friends, either one adding the other to the blocklist removes them from each otherâs friend list.
> If user A blocks user B, or vice versa, then neither of them can send a friend request to the other person.If user B is on user Aâs blocklist and user A is also on user Bâs blocklist, then user A and B cannot start a conversation with each other.
> -> If user B is on user Aâs blocklist, but user A is not on user Bâs blocklist, then user A can message user B but not the other way around.
...
- [Deleting a user from the blocklist](https://intl.cloud.tencent.com/document/product/1047/34912)
- [Querying a blocklist](https://intl.cloud.tencent.com/document/product/1047/34914)
- [Verifying a blocklist](https://intl.cloud.tencent.com/document/product/1047/34913)

## Possible Callback

[Callback after adding users to the blocklist](https://intl.cloud.tencent.com/document/product/1047/34361)


---
*Source: [https://trtc.io/document/34911](https://trtc.io/document/34911)*
