...
| CheckType | String | Yes | Verification mode. For more information, see [Verifying a blocklist](https://intl.cloud.tencent.com/document/product/1047/33521). |
...
| Relation | String | The blocklist relationship between `To_Account` and `From_Account` upon successful verification. For details, see [Verifying a blocklist](https://intl.cloud.tencent.com/document/product/1047/33521). |
...
---
*Source: [https://trtc.io/document/34913](https://trtc.io/document/34913)*
