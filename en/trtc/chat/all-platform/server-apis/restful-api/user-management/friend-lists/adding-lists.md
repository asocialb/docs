...
| GroupName | Array | Yes | List of new group lists.**Noteï¼**Since the maximum number of groups is 32, a single request must not exceed 32 groups. |
...
- Deleting Lists ([v4/sns/group_delete](https://intl.cloud.tencent.com/document/product/1047/34926))


---
*Source: [https://trtc.io/document/34950](https://trtc.io/document/34950)*
