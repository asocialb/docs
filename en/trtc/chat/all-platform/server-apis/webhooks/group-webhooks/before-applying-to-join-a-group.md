...
It will be triggered before the Chat backend adds the user sending the group join request to the group (or before the admin is notified if admin approval is required).
...
```
{    "CallbackCommand": "Group.CallbackBeforeApplyJoinGroup", // Callback command    "GroupId" : "@TGS#2J4SZEAEL",    "Type": "Public", // Group type    "Requestor_Account": "jared", // Requester    "ApplyMsg" : "test",  // Apply to join the group message    "EventTime":"1670574414123"// Event trigger timestamp in milliseconds		}
```
...
| ApplyMsg | String | Apply to join the group message. |
...
```
{    "ActionStatus": "OK",    "ErrorInfo": "",    "ErrorCode": 1 // It indicates to reject the group join request.}
```
...
---
*Source: [https://trtc.io/document/34370](https://trtc.io/document/34370)*
