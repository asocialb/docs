...
This callback will be triggered before the Chat backend adds the target user to the group (or after the friendship verification is passed, if relationship chain hosting is involved and friendship verification is configured in Chat for the app).
...
---
*Source: [https://trtc.io/document/34371](https://trtc.io/document/34371)*
