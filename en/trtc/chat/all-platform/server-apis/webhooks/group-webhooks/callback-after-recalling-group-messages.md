...
| MsgSeqList | Array | List of recalled messagesï¼which containing `MsgId` and `MsgSeq`fields , representing the client message unique identifier and message MsgSeq of the withdrawn message, respectively. |
