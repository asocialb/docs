...
- During this callback, the Chat backend initiates an HTTPS POST request to the app backend.
...
The callback is triggered after the Chat backend receives a one-to-one message sent by a user and sends the message to the target user.

> **Note:**If the Chat backend fails to send the message, for example, due to filtering of restricted words, the callback is still triggered.
...
---
*Source: [https://trtc.io/document/34365](https://trtc.io/document/34365)*
