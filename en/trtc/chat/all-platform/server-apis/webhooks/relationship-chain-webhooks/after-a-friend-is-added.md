...
- The app backend uses the RESTful API to initiate a two-way friend addition request, and the peerâs friend request verification mode is "AllowAny".
- The app backend uses the client to initiate a two-way friend addition request, and the peerâs friend verification mode is "AllowAny".
...
> **Caution:**This callback will not be triggered if the API for [importing friends](https://intl.cloud.tencent.com/document/product/1047/34903) is invoked to add a friend.
...
---
*Source: [https://trtc.io/document/34359](https://trtc.io/document/34359)*
