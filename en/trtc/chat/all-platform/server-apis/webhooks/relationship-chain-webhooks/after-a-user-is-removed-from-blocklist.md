...
The callback is triggered after the Chat backend receives a request to remove users from blocklist and successfully remove the users.
...
---
*Source: [https://trtc.io/document/34362](https://trtc.io/document/34362)*
