...
> **Caution:**Responses initiated via RESTful API calls to friend requests will not trigger the callback.
...
| TagName | String | Friend list set by `From_Account` for `To_Account`. For more information, see the **Standard friend fields** section in [Contacts Management](https://intl.cloud.tencent.com/document/product/1047/33521). |
...
---
*Source: [https://trtc.io/document/43467](https://trtc.io/document/43467)*
