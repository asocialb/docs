...
Call the `searchGroups` API ([details](https://pub.dev/documentation/tencent_cloud_chat_sdk/latest/manager_v2_tim_group_manager/V2TIMGroupManager/searchGroups.html)) to search a local group.
...
---
*Source: [https://trtc.io/document/48139](https://trtc.io/document/48139)*
