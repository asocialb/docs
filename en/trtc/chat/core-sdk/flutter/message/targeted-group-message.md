...
> **Note:**This feature is supported only by the SDK for Flutter on v3.8.0 or later.To use this feature, you need to purchase the Pro edition ãPro Plus edition or Enterprise edition.The original message object used to create a targeted group message cannot be a group @ message.The targeted group message feature is unavailable for communities (Community) and audio-video groups (AVChatRoom).By default, targeted group messages are excluded from the unread count of a group conversation.
...
---
*Source: [https://trtc.io/document/48028](https://trtc.io/document/48028)*
