...
| [searchLocalMessages](https://im.sdk.qcloud.com/doc/en/swift_V2TIMManager+Message.html#v2timmanager.searchlocalmessages(param:succ:fail:)) | Search for local messages. |
| [searchCloudMessages](https://im.sdk.qcloud.com/doc/en/swift_V2TIMManager+Message.html#v2timmanager.searchcloudmessages(param:succ:fail:)) | Search for cloud messages. |
...
| [addMessageReaction](https://im.sdk.qcloud.com/doc/en/swift_V2TIMManager+Message.html#v2timmanager.addmessagereaction(message:reactionid:succ:fail:)) | Adds message reaction. |
| [removeMessageReaction](https://im.sdk.qcloud.com/doc/en/swift_V2TIMManager+Message.html#v2timmanager.removemessagereaction(message:reactionid:succ:fail:)) | Removes message reaction. |
| [getMessageReactions](https://im.sdk.qcloud.com/doc/en/swift_V2TIMManager+Message.html#v2timmanager.getmessagereactions(messagelist:maxusercountperreaction:succ:fail:)) | Gets message reactions. |
| [getAllUserListOfMessageReaction](https://im.sdk.qcloud.com/doc/en/swift_V2TIMManager+Message.html#v2timmanager.getalluserlistofmessagereaction(message:reactionid:nextseq:count:succ:fail:)) | Gets all user list of message reaction. |
...
| [searchGroups](https://im.sdk.qcloud.com/doc/en/swift_V2TIMManager+Group.html#v2timmanager.searchgroups(searchparam:succ:fail:)) | Search for local group profiles. |
| [searchCloudGroups](https://im.sdk.qcloud.com/doc/en/swift_V2TIMManager+Group.html#v2timmanager.searchcloudgroups(searchparam:succ:fail:)) | Search for cloud group profiles. |
...
| [searchGroupMembers](https://im.sdk.qcloud.com/doc/en/swift_V2TIMManager+Group.html#v2timmanager.searchgroupmembers(searchparam:succ:fail:)) | Search for local group members. |
| [searchCloudGroupMembers](https://im.sdk.qcloud.com/doc/en/swift_V2TIMManager+Group.html#v2timmanager.searchcloudgroupmembers(searchparam:succ:fail:)) | Search for cloud group members. |
...
| [searchUsers](https://im.sdk.qcloud.com/doc/en/swift_V2TIMManager.html#v2timmanager.searchusers(param:succ:fail:)) | Search cloud users |
...
Use the offline push service if you want your app to receive IM messages in real time when it runs in the background. As there is currently no unified push service in the Chinese mainland, you need to [Offline Push(iOS)](https://www.tencentcloud.com/document/product/1047/67685#).
...
| API | Description |
| --- | --- |
| [addFriendListener](https://im.sdk.qcloud.com/doc/en/swift_V2TIMManager+Friendship.html#v2timmanager.addfriendlistener(listener:)) | Adds a Contacts listener to receive friend list and blocklist change events. |
| [removeFriendListener](https://im.sdk.qcloud.com/doc/en/swift_V2TIMManager+Friendship.html#v2timmanager.removefriendlistener(listener:)) | Removes Contacts listener. |
...
---
*Source: [https://trtc.io/document/51450](https://trtc.io/document/51450)*
