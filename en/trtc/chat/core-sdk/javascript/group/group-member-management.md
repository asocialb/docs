...
```
// filter the list of online members in the AVChatRoomlet promise = chat.getGroupMemberList({ groupID: 'group1', filter: 1000, offset: 0 });
...
---
*Source: [https://trtc.io/document/48180](https://trtc.io/document/48180)*
