...
| needReadReceipt | Boolean | false | Whether a read receipt is needed. `true` indicates yes. To use it, you need to purchase the Pro edition ãPro Plus edition or Enterprise edition package. |
...
| isSupportExtension | Boolean | false | whether the message supports extensions. `true` indicates yes. To use it, you need to purchase the Pro edition ãPro Plus edition or Enterprise edition package. |
...
---
*Source: [https://trtc.io/document/47990](https://trtc.io/document/47990)*
