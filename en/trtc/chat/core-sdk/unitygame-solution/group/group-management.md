...
> **Caution:** You need to call `SetGroupTipsEventCallback` to add a group event listener in advance to receive the following group events.
...
> **Caution:** The group owner **cannot** leave a public group (Public), meeting group (Meeting), community, or audio-video group (AVChatRoom) and can only disband it.
...
---
*Source: [https://trtc.io/document/48463](https://trtc.io/document/48463)*
