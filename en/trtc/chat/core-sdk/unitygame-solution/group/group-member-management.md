...
> **Note:**Currently, only the number of online members in an audio-video group (AVChatRoom) can be obtained.This API can be called once every 60 seconds in the SDK.
...
---
*Source: [https://trtc.io/document/50319](https://trtc.io/document/50319)*
