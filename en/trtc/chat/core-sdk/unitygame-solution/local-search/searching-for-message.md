...
> **Note:** This feature is supported only by the Ultimate edition.
...
| Parameter | Definition | Description |
| --- | --- | --- |
| msg_search_result_total_count | Total number of the search result items | If the specified conversation is searched, the **total number of messages** that meet the search criteria will be returned.If all the conversations are searched, the **total number of the conversations** to which messages that meet the search criteria belong will be returned. |
...
---
*Source: [https://trtc.io/document/50066](https://trtc.io/document/50066)*
