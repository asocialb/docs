...
> **Note:**After a historical local message is deleted, the message will be marked as deleted locally by the SDK and can no longer be pulled through `MsgGetMsgList`.If the application is uninstalled and reinstalled, the deletion marker will be lost locally, and the message can still be pulled through `MsgGetMsgList`.
...
---
*Source: [https://trtc.io/document/48877](https://trtc.io/document/48877)*
