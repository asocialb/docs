...
| --- | --- | --- |
| message | Message object | Three message conditions to meet:Set message_support_message_extension ([details](https://comm.qq.com/im/doc/unity/zh/types/MessageAttributes/Message.html)) to `true` before message sending.The message is sent successfully.The message is not a message of a community/audio-video group. |
...
---
*Source: [https://trtc.io/document/53445](https://trtc.io/document/53445)*
