...
| message_need_read_receipt | Whether the message requires a read receipt (to use this feature, you need to purchase the Pro edition ãPro Plus edition or Enterprise edition on v6.1 or later). To use this feature for group messages, go to the Chat console to set the target group type first. |
...
---
*Source: [https://trtc.io/document/48869](https://trtc.io/document/48869)*
