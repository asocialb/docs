...
> **Note:** This feature is supported only on native SDK 6.2.2363 or later.
...
```
TencentIMSDK.SetMsgUpdateCallback((List<Message> message_list, string user_data) => {  // `message_list` is the list of modified message objects.});
```


---
*Source: [https://trtc.io/document/53444](https://trtc.io/document/53444)*
