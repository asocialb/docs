...
The ChatSDK will download video messages when free, which can be directly used by you and will be cleared when the application is uninstalled.
...
The Chat SDK will download audio messages when free, which can be directly used by you and will be cleared when the application is uninstalled.
...
The Chat SDK will download file messages when free, which can be directly used by you and will be cleared when the application is uninstalled.
...
> **Note:** Group tip messages will be received by only group members but not one-to-one chat parties.
...
---
*Source: [https://trtc.io/document/48573](https://trtc.io/document/48573)*
