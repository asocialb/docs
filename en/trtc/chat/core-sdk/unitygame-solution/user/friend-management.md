...
The Chat SDK supports the logic for the friend contacts. You can call the `FriendshipGetFriendProfileList` API ([details](https://comm.qq.com/im/doc/unity/zh/api/FriendshipApi/FriendshipGetFriendProfileList.html)) to get contacts.
...
1. Users A and B call `SetOnAddFriendCallback` to set the contacts listener.
