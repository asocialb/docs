...
- Open the specified interface within the app: clicking the notification bar will redirect the interface based on the configured self Definition, see [Custom Redirect on Click](https://trtc.io/document/60575).
...
| Vendor Push Platform | Configuring in the IM console |
| --- | --- |
| ![](https://cloudcache.intl.tencent-cloud.com/cms/backend-cms/64340562b30911ef9dc0525400329841.png) | ![](https://cloudcache.intl.tencent-cloud.com/cms/backend-cms/63f65c8eb30911ef8b1b525400f69702.png) **Note:**Client ID corresponds to AppID, Client Secret corresponds to AppSecret. |
...
---
*Source: [https://trtc.io/document/67570](https://trtc.io/document/67570)*
