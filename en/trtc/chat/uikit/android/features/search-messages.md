...
> **Note:**The local search feature is only available on the Chat Ultimate edition. To use it, [purchase the Pro edition ãPro Plus edition ãEnterprise edition](https://intl.cloud.tencent.com/document/product/1047/34577). For more information, see [Pricing](https://intl.cloud.tencent.com/document/product/1047/34350).
...
[Purchase the Pro edition ã Pro Plus edition ãEnterprise edition](https://intl.cloud.tencent.com/document/product/1047/34577).
...
```
TUILogin.login(this, SDKAPPID, userID, userSig, new TUICallback() {    @Override    public void onError(final int code, final String desc) {        // Login fails.    }    @Override    public void onSuccess() {        // Login succeeded    }});
```
...
---
*Source: [https://trtc.io/document/50038](https://trtc.io/document/50038)*
