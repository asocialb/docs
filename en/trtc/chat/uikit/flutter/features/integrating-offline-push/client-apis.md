...
| API | Description |
| --- | --- |
| [registerPush](#0686c8e9-27c3-4a2e-9176-1e81b925a6f3) | Register Push Service, optionally override push information from interface parameter JSON. |
...
| apnsCertificateID |  | int? | The iOS push notification certificate ID you configured. |  |
...
---
*Source: [https://trtc.io/document/67581](https://trtc.io/document/67581)*
