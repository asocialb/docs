...
> **Indication** Your App's `Bundle ID` cannot use a wildcard `*`, otherwise, remote push service will not be available.
...
> **Caution** When saving the `P12` file, make sure to set a password.

### Step 2: Upload the certificate to the console

1. log in  [Chat  Console](https://console.tencentcloud.com/im).
...
- Open the specified interface within the app: clicking the notification bar will redirect the interface based on the configured self Definition, see [Custom Redirect on Click](https://www.tencentcloud.com/document/product/1047/60575).
...
| Vendor Push Platform | Configuring in the Chat console |
| --- | --- |
| ![](https://cloudcache.intl.tencent-cloud.com/cms/backend-cms/4354ce57b30d11ef970f525400d5f8ef.png) | ![](https://cloudcache.intl.tencent-cloud.com/cms/backend-cms/4292a06cb30d11ef970f525400d5f8ef.png) **Note:**Client ID corresponds to AppID, Client Secret corresponds to AppSecret. |
...
---
*Source: [https://trtc.io/document/67580](https://trtc.io/document/67580)*
