...
Before integrating **@tencentcloud/react-native-push**, you need to apply for an APNs push certificate from Apple and upload it to the Chat console. Then follow the [Quick Connection](https://www.tencentcloud.com/document/product/1047/67584#) steps to integrate.
...
---
*Source: [https://trtc.io/document/67583](https://trtc.io/document/67583)*
