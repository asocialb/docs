...
You can set the style of list items in the conversation list in the path `TUIKit/components/TUIConversation/conversation-list/style/h5.scss`.
...
---
*Source: [https://trtc.io/document/50046](https://trtc.io/document/50046)*
