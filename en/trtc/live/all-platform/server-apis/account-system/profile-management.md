...
Live and Instant Messaging (Chat) share the same account system, and the data belongs to some information bound to the user in the account system.
...
- The name of the custom profile field (Key). For more information, see [Naming Rules for Custom Profile Fields](https://www.tencentcloud.com/document/product/647/69884#naming-rules-for-custom-profile-fields).
- The type of the custom profile field (Value). For more information, see [Profile Fields](https://www.tencentcloud.com/document/product/647/69884#profile-fields).
...
---
*Source: [https://trtc.io/document/69884](https://trtc.io/document/69884)*
