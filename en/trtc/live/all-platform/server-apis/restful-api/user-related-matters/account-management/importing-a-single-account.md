...
> **Note:**If the same account is imported to Chat repeatedly, only one internal ID will be created for the account.
...
| 70398 | The number of accounts exceeds the limit allowed. To create more than 100 accounts, upgrade your app to the Premium edition. For specific steps, see [Purchase Guide](https://trtc.io/document/67650?platform=web&product=chat&menulabel=uikit). |
...
| 70403 | The request failed. It requires the app adminâs permissions. |
...
---
*Source: [https://trtc.io/document/34953](https://trtc.io/document/34953)*
