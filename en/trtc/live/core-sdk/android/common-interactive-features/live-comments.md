...
Do not respond to every data update. Instead, set a time threshold (e.g., 300 ms). Only refresh the UI if the time since the last update exceeds this threshold. This reduces dozens of `notifyDataSetChanged()`calls per second to just 3â4, greatly improving smoothness.
...
---
*Source: [https://trtc.io/document/74601](https://trtc.io/document/74601)*
