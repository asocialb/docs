...
| --- | --- | --- | --- |
| Action | Yes | String | [Common Params](https://www.tencentcloud.com/document/api/647/34263). The value used for this API: DeleteCloudModeration. |
...
### Example1 Stopping Cloud Moderation Tasks
...
---
*Source: [https://trtc.io/document/72647](https://trtc.io/document/72647)*
