...
| --- | --- | --- | --- |
| Action | Yes | String | [Common Params](https://www.tencentcloud.com/document/api/647/34263). The value used for this API: ModifyCloudModeration. |
...
| TaskId | Yes | String | Unique ID of the moderation task, which is returned after the task is started. |
| SubscribeStreamUserIds | No | [SubscribeStreamUserIds](https://www.tencentcloud.com/document/api/647/36760#SubscribeStreamUserIds) | Specifies the allowlist or blocklist for the subscription stream. |
...
### Example1 Modifying Cloud Moderation Tasks
...
---
*Source: [https://trtc.io/document/72645](https://trtc.io/document/72645)*
