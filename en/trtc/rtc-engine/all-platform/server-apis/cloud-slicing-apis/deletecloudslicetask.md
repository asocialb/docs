...
| --- | --- | --- | --- |
| Action | Yes | String | [Common Params](https://www.tencentcloud.com/document/api/647/34263). The value used for this API: DeleteCloudSliceTask. |
...
### Example1 Stopping a Cloud Slicing Task
...
---
*Source: [https://trtc.io/document/72330](https://trtc.io/document/72330)*
