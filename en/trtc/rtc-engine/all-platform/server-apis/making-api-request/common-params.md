...
| SecretId | String | Yes | The identifying SecretId obtained on the [Cloud API Key](https://console.tencentcloud.com/capi) page. A SecretId corresponds to a unique SecretKey which is used to generate the request signature (Signature). |
...
---
*Source: [https://trtc.io/document/34263](https://trtc.io/document/34263)*
