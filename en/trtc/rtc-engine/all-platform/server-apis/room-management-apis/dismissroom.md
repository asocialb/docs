...
| --- | --- | --- | --- |
| Action | Yes | String | [Common Params](https://www.tencentcloud.com/document/api/647/34263). The value used for this API: DismissRoom. |
...
This example shows you how to close room `1234`.
...
---
*Source: [https://trtc.io/document/34269](https://trtc.io/document/34269)*
