...
| --- | --- | --- | --- |
| Action | Yes | String | [Common Params](https://www.tencentcloud.com/document/api/647/34263). The value used for this API: SetUserBlocked. |
...
| RoomId | Yes | Integer | The room ID (number). |
...
### Example1 Disabling the audio and video of a user
...
---
*Source: [https://trtc.io/document/51289](https://trtc.io/document/51289)*
