...
This API is used to query your usage of TRTCâs On-Cloud MixTranscoding service.
...
| --- | --- | --- | --- |
| Action | Yes | String | [Common Params](https://www.tencentcloud.com/document/api/647/34263). The value used for this API: DescribeMixTranscodingUsage. |
...
---
*Source: [https://trtc.io/document/54140](https://trtc.io/document/54140)*
