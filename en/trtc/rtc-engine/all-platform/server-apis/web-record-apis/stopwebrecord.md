...
| --- | --- | --- | --- |
| Action | Yes | String | [Common Params](https://www.tencentcloud.com/document/api/647/34263). The value used for this API: StopWebRecord. |
...
| TaskId | Yes | String | The ID of the task that needs to be stopped |
...
### Example1 Stop an web-page recording task
...
---
*Source: [https://trtc.io/document/72065](https://trtc.io/document/72065)*
