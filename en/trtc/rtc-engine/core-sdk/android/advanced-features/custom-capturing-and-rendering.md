...
> **explain** In order to avoid performance loss, there are different format requirements for the video data input to the TRTC SDK on different platforms. For more information, see [LiteAVSDK Overview](https://liteav.sdk.qcloud.com/doc/api/en/md_introduction_trtc_en_TRTCSDK_Download.html).
...
---
*Source: [https://trtc.io/document/35158](https://trtc.io/document/35158)*
