...
- [iOSï¼SetVideoQualityViewController.m](https://github.com/LiteAVSDK/TRTC_iOS/tree/main/TRTC-API-Example-OC/Advanced/SetVideoQuality/SetVideoQualityViewController.m)
- [Androidï¼SetVideoQualityActivity.java](https://github.com/LiteAVSDK/TRTC_Android/tree/main/TRTC-API-Example/Advanced/SetVideoQuality/src/main/java/com/tencent/trtc/videoquality/SetVideoQualityActivity.java)
...
> **notice** As many hardware codecs only support pixel widths that are divisible by 16, the actual resolution encoded by the SDK is not necessarily exactly the same as configured by the parameter; instead, it will be automatically corrected based on the divisor of 16; for example, the resolution 640x360 may be adapted to 640x368 inside the SDK.
...
4. Higher bitrates also require higher resolutions for a match. For a resolution of 320x240, a 1,000 Kbps bitrate would be wasteful. We recommend that you set it as described in the [Resolution-bitrate reference table](/document/product/647/35153#resolution-bitrate-reference-table).
...
---
*Source: [https://trtc.io/document/35153](https://trtc.io/document/35153)*
