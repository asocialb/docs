...
| FuncList | DESC |
| --- | --- |
| [TRTCLocalStatistics](https://www.tencentcloud.com/document/product/647/50764#a2e3e0ed7d189702c1f6466710efb14e) | Local audio/video metrics. |
| [TRTCRemoteStatistics](https://www.tencentcloud.com/document/product/647/50764#31083ca966a8ee092affeab44b65fe9a) | Remote audio/video metrics. |
| [TRTCStatistics](https://www.tencentcloud.com/document/product/647/50764#2a1e88fd90554975be810d09be8b16f6) | Network and performance metrics. |
...
| localArray | Field description: local audio/video statisticsAs there may be three local audio/video streams (i.e., HD big image, smooth small image, and substream image), the local audio/video statistics are an array. |
| receiveBytes | Field description: total number of received bytes (including signaling data and audio/video data) |
| remoteArray | Field description: remote audio/video statisticsAs there may be multiple concurrent remote users, and each of them may have multiple concurrent audio/video streams (i.e., HD big image, smooth small image, and substream image), the remote audio/video statistics are an array. |
...
---
*Source: [https://trtc.io/document/50764](https://trtc.io/document/50764)*
