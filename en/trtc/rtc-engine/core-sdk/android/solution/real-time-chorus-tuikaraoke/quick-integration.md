...
- **SDKAppID**: **TRTC application ID**. If you haven't activated the TRTC service, log in to the [TRTC console](https://console.tencentcloud.com/trtc/app), create a TRTC application, and click **Application Info**, `SDKAppID` information is as shown in the figure below:
![](https://cloudcache.intl.tencent-cloud.com/cms/backend-cms/5bf13347b5d011eeb2a1525400170219.png)
- **Secretkey**: **TRTC application key**, which corresponds to `SDKAppID`. On the [Application Management](https://console.tencentcloud.com/trtc/app) page in the TRTC console, the `SecretKey` is as shown below:
...
- **userSig**: Security protection signature calculated based on `SDKAppID`, `userId`, and `Secretkey`. You can click [here](https://console.trtc.io/usersig) to directly generate a debugging `userSig` online. For more information, see [UserSig](https://intl.cloud.tencent.com/document/product/647/35166).
...
> **Note** You can implement other seat management operations as instructed in [TRTCKaraoke (Android)](https://intl.cloud.tencent.com/document/product/647/41943) or by referring to the [TUIKaraoke demo project](https://github.com/tencentyun/TUIKaraoke/).

4. **Play back songs and try out the karaoke scenario**
You can get the music ID and URL to play back a song based on your business. For more information, see [Music Playback APIs](https://www.tencentcloud.com/document/product/647/41943#music-playback-apis2).
...
---
*Source: [https://trtc.io/document/41941](https://trtc.io/document/41941)*
