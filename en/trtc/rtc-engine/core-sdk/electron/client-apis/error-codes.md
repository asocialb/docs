...
| ERR_ROOM_REQUEST_START_PUBLISHING_TIMEOUT | -3333 | Signaling of starting to push to Tencent Cloudâs live streaming CDN timed out. |
| ERR_ROOM_REQUEST_START_PUBLISHING_ERROR | -3334 | Abnormal signaling of starting to push to Tencent Cloudâs live streaming CDN. |
| ERR_ROOM_REQUEST_STOP_PUBLISHING_TIMEOUT | -3335 | Signaling of stopping pushing to Tencent Cloudâs live streaming CDN timed out. |
| ERR_ROOM_REQUEST_STOP_PUBLISHING_ERROR | -3336 | Abnormal signaling of stopping pushing to Tencent Cloudâs live streaming CDN. |
...
| WARNING_RTMP_SERVER_RECONNECT | 1102 | Push error. The network is disconnected. Reconnectingâ¦ (max attempts: 3). |
| WARNING_LIVE_STREAM_SERVER_RECONNECT | 2103 | Pull error. The network is disconnected. Reconnectingâ¦ (max attempts: 3). |
...
| WARNING_ROOM_RECONNECT | 5102 | Network disconnected. Reconnectingâ¦ |
| WARNING_ROOM_NET_BUSY | 5103 | Bad network connection: Data upload blocked due to limited upstream bandwidth. |


---
*Source: [https://trtc.io/document/35142](https://trtc.io/document/35142)*
