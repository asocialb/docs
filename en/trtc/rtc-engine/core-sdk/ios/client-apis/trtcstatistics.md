...
| FuncList | DESC |
| --- | --- |
| [TRTCLocalStatistics](https://www.tencentcloud.com/document/product/647/50756#a2e3e0ed7d189702c1f6466710efb14e) | Local audio/video metrics. |
| [TRTCRemoteStatistics](https://www.tencentcloud.com/document/product/647/50756#31083ca966a8ee092affeab44b65fe9a) | Remote audio/video metrics. |
| [TRTCStatistics](https://www.tencentcloud.com/document/product/647/50756#1d6d431e74a86078f2fd05bf4f3efb7a) | Network and performance metrics. |
...
| localStatistics | Field description: local audio/video statisticsAs there may be three local audio/video streams (i.e., HD big image, smooth small image, and substream image), the local audio/video statistics are an array. |
| receivedBytes | Field description: total number of received bytes (including signaling data and audio/video data) |
| remoteStatistics | Field description: remote audio/video statisticsAs there may be multiple concurrent remote users, and each of them may have multiple concurrent audio/video streams (i.e., HD big image, smooth small image, and substream image), the remote audio/video statistics are an array. |
...
---
*Source: [https://trtc.io/document/50756](https://trtc.io/document/50756)*
