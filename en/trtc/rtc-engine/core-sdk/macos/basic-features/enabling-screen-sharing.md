...
> **explain** Two additional parameters:`capturesCursor`: specifies whether to capture the cursor.`highlight`: specifies whether to highlight the window being shared and remind the user to move the window when it is covered. The relevant UI design is implemented within the SDK.
...
| --- | --- | --- | --- |
| FHD | 1920 Ã 1080 | 10 | 800 Kbps |
| HD | 1280 Ã 720 | 10 | 600 Kbps |
...
---
*Source: [https://trtc.io/document/37336](https://trtc.io/document/37336)*
