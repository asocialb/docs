...
| API | Description |
| --- | --- |
| [startPublishing](https://comm.qq.com/en-trtc/api/trtc.ITRTCCloud.html#trtc_ITRTCCloud_startPublishing_System_String_trtc_TRTCVideoStreamType_) | Starts pushing to Tencent Cloudâs live streaming CDN. |
| [stopPublishing](https://comm.qq.com/en-trtc/api/trtc.ITRTCCloud.html#trtc_ITRTCCloud_stopPublishing) | Stops pushing to Tencent Cloudâs live streaming CDN. |
...
---
*Source: [https://trtc.io/document/40139](https://trtc.io/document/40139)*
