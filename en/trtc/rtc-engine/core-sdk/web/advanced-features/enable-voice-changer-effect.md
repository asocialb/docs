...
```
await trtc.startPlugin('VoiceChanger', {  voiceType: 1,  sdkAppId: 123456,  userId: 'user_123',  userSig: 'XXXXXXXX'});// Update parameters after activationawait trtc.updatePlugin('VoiceChanger', {  voiceType: 2,});// Disable the plugin before stopping microphoneawait trtc.stopPlugin('VoiceChanger');await trtc.stopLocalAudio();
```
...
```
// Disable the plugin before stopping microphoneawait trtc.stopPlugin('VoiceChanger');await trtc.stopLocalAudio();
```


---
*Source: [https://trtc.io/document/69472](https://trtc.io/document/69472)*
