...
- [Ориентация в консоли](ориентация-в-консоли.md) — знакомство с интерфейсом консоли
- [Первые шаги после входа](первые-шаги-после-входа.md) — рекомендуемые действия после первого входа
